...
- **Endpoint**：`POST https://app-d534qwn7c9vl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-d534qwn7c9vl-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
